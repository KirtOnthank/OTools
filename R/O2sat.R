#' Convert oxygen concentration data in percent atmospheric saturation into various other units
#' 
#' This function will convert between oxygen concentration in water expressed in percent oxygen saturation to other units of concentration and pressure.
...
O2sat=function(value,salinity=32,temp=11,atmP=1013.25) {
  A1=-173.4292
  A2=249.6339
  A3=143.3483
  A4=-21.8492
  ...
  kPa=hPa.mbar/10
  torr=hPa.mbar*0.75
  umolO2.per.L=(O2sat/100)*fullsat
  mgO2.per.L=umolO2.per.L*(MWO2/1000)
