...
#' @return Returns a dataframe with one row per measured oxygen concentration value entered. Columns report salinity, temperature and atmospheric pressure used, and then retuns oxygen concentration/pressure in Saturation (percent), kilopascals (kPa), hectopascals or millibar (hPa.mbar), torr, umolO2/liter, and mgO2/L.
#' @export
